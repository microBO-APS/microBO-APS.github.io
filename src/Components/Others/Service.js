...
const Service = () => {
    ...
    return (
        ...
        <div className='leftImage' id='imagessalaProve'>
            <img className ='serviceImg' src={cassa} alt='service'></img>
        </div>
        <div className='rightContent' id='descriptionsalaProve'>
            ...
            <h1 style={{marginTop:'10%'}}>Service</h1>

            <p className='pDescription' >È possibile chiedere a Micro-Bo la strumentazione per eventi.<br></br> Puoi compilare il form per contattarci ed indicarci di cosa avresti bisogno.  </p>
        ...
        <div className="formContainer">
            <form ref={form} onSubmit={sendEmail}>
                <label>Oggetto</label>
                <input type="text" disabled name="subject" value='Service' />
                <input style={{display:'none'}} type="text" name="subject" value='Service' />
