  ...
  return (
    <div className='Sala' style = {{backgroundImage: `url(${mixerFake})`, backgroundPosition:'91% 80%'}} id='produzione'>
        ...
        <div className='rightContent' id='descriptionproduzione'>
            ...
            <p className='pDescription' >La produzione si compone di due ambienti.<br></br> <b>Booth</b><br></br> una sala destinata esclusivamente alla registrazione in solo di voci e strumenti. È fornita di amplificatore Fender valvolare, ampli basso, microfono a condensatore. È presente inoltre un Fender Rhodes originale.<br></br>
            <b>Regia</b><br></br>È posibile prendere il segnale di ampli/microfoni/rhodes tramite il cablaggio via mixer alla scheda audio. Basta collegare il proprio computer o il mac già presente. <br></br>Rockit per gli ascolti. <br></br> <span style={{color:'red'}}>ATTUALMENTE INAGIBILE LAVORI IN CORSO</span> </p>
        ...
        <h1>Calendario produzione</h1>
            <p className='pDescription'>Qui puoi vedere quando è libera la produzione. <br></br> Dal lunedì al venerdi siamo aperti dalle 9:00 fino alle 22:00. Il sabato siamo aperti dalle 10:00 alle 20:00. <br></br>Domenica siamo al bar. 🍷</p>
        ...
        <div className="buttonCalendarContainer">
            <Button className='buttonCalendar' id="salaProveCalendarButton"color='orange' onClick={(e)=>handleCalendar('produzione',e.target)} style={{margin:"auto",marginTop:"100px"}}>Controlla il calendario</Button>
        </div>
    </div>
  )
}
